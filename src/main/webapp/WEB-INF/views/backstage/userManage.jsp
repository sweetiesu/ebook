...
<head>
    ...
    <title>在线电子书 - 用户管理</title>
</head>
<body>
<nav id="nav" class="navbar navbar-default" role="navigation">
    <div class="container container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="#"><span class="h3 text-success">在线电子书</span></a>
        </div>
        <div class="nav">
            ...
            <div id="user" class="pull-right">
                <h4 class="text-primary">欢迎进入在线电子书后台管理系统！&nbsp;
                    <span class="glyphicon glyphicon-user">admin</span><a href="/logout">注销</a></h4>
            </div>
        </div>
    </div>
</nav>
